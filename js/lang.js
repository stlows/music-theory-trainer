const res = {
  ...
  ionian: { fr: "Majeur (Ionien)", en: "Major (Ionian), I" },
  dorian: { fr: "Dorien (♭3, ♭7)", en: "Dorian (♭3, ♭7)" },
  phrygian: { fr: "Phrygien (♭2, ♭3, ♭6)", en: "Phrygian (♭2, ♭3, ♭6)" },
  lydian: { fr: "Lydien (♯4)", en: "Lydian (♯4)" },
  mixolydian: { fr: "Mixolydien (♭7)", en: "Mixolydian (♭7)" },
  aeolian: { fr: "Mineur Naturel (Éolien) (♭3, ♭6, ♭7)", en: "Natural Minor (Aeolian) (♭3, ♭6, ♭7)" },
  locrian: { fr: "Locrien (♭2, ♭3, ♭5, ♭6, ♭7)", en: "Locrian (♭2, ♭3, ♭5, ♭6, ♭7)" },

  harmonicMinor: { fr: "Mineur Harmonique (♭3, ♭6)", en: "Harmonic Minor (♭3, ♭6)" },
  melodicMinorAsc: { fr: "Mineur Mélodique (Ascendant) (♭3)", en: "Melodic Minor (Ascending) (♭3)" },
  melodicMinorDesc: { fr: "Mineur Mélodique (Descendant) (♭3, ♭6, ♭7)", en: "Melodic Minor (Descending) (♭3, ♭6, ♭7)" },
  ...
  playFrom: { fr: "Jouer à partir de", en: "Play from" },
  stopBars: { fr: "Stop", en: "Stop" },
